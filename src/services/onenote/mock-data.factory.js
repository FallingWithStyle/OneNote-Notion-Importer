...
exports.OneNoteMockDataFactory = void 0;
class OneNoteMockDataFactory {
    /**
     * Create a mock page with default values
     */
    static createMockPage(overrides = {}) {
        return {
            id: 'mock-page',
            title: 'Mock Page',
     ...
     */
    static createMockSection(overrides = {}) {
        return {
            id: 'mock-section',
            name: 'Mock Section',
     ...
     */
    static createMockNotebook(overrides = {}) {
        return {
            id: 'mock-notebook',
            name: 'Mock Notebook',
     ...
     */
    static createMockHierarchy(overrides = {}) {
        return {
     ...
     */
    static createMockExtractionResult(overrides = {}) {
        return {
            success: true,
     ...
     */
    static createFallbackHierarchy(type = 'extraction') {
     ...
     */
    static createMultipleMockPages(count) {
        return Array.from({ length: count }, (_, index) => this.createMockPage({
            id: `page-${index + 1}`,
            title: `Page ${index + 1}`,
     ...
     */
    static createMultipleMockSections(count) {
        return Array.from({ length: count }, (_, index) => this.createMockSection({
            id: `section-${index + 1}`,
     ...
     */
    static createMultipleMockNotebooks(count) {
        return Array.from({ length: count }, (_, index) => this.createMockNotebook({
            id: `notebook-${index + 1}`,
...
exports.OneNoteMockDataFactory = OneNoteMockDataFactory;
